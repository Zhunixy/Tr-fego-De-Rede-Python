...
`email` varchar(45) not null unique, -- Atributo "email", tipo texto, 45 caracteres, não pode ser vazio
...
`document` varchar(45) not null unique, -- Atributo "document", tipo texto, 45 caracteres, não pode ser vazio
